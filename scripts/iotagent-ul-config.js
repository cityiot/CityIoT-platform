...
config.iota = {
    ...
    server: {
         ...
         */
        port: process.env.IOTA_NORTH_PORT || 4061
    },
    ...
    mongodb: {
         ...
         */
        host: process.env.IOTA_MONGO_HOST || 'mongodb',
         ...
         */
        db: process.env.IOTA_MONGO_DB || 'iotagent-ul',
     ...
     */
    providerUrl: process.env.IOTA_PROVIDER_URL || 'http://iotagent-ul:4061',
